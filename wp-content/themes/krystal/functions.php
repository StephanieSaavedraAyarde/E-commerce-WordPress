...
function krystal_scripts() {
	...
	if(true===get_theme_mod( 'kr_enable_minify_styles',true)) {
		wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/css/compressed/bootstrap.min.css', array(), '3.3.7');
		wp_enqueue_style( 'fontawesome', get_template_directory_uri() . '/css/compressed/fontawesome.min.css', array(), '5.10.1');
		wp_enqueue_style( 'magnific-popup', get_template_directory_uri() . '/css/compressed/magnific-popup.min.css', array(), '1.1.0');
		wp_enqueue_style( 'krystal-style', get_template_directory_uri() . '/css/compressed/krystal-style.min.css', array(), wp_get_theme()->get('Version'));
		wp_enqueue_style( 'm-customscrollbar-css', get_template_directory_uri() . '/css/compressed/jquery.mCustomScrollbar.min.css', array(), '1.0');
	}
	else {
	...
	//wp_enqueue_style( 'poppins-google-font', 'https://fonts.googleapis.com/css?family=Poppins:300,400,700,900&display=swap', array(), '1.0');
	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}

	/* check for minified scripts */
	if(true===get_theme_mod( 'kr_enable_minify_scripts',true)) {
		wp_enqueue_script( 'bootstrap-js', get_template_directory_uri() . '/js/compressed/bootstrap.min.js', array(), '3.3.7', true );
		wp_enqueue_script( 'jquery-easing', get_template_directory_uri() . '/js/compressed/jquery.easing.1.3.min.js', array('jquery'), '1.3', true );
		wp_enqueue_script( 'modernizr', get_template_directory_uri() . '/js/compressed/modernizr.min.js', array(), '2.6.2', true );		
		wp_enqueue_script( 'parallax', get_template_directory_uri() . '/js/compressed/parallax.min.js',array(),'1.4.2', true );	
		wp_enqueue_script( 'jquery-magnific', get_template_directory_uri() . '/js/compressed/jquery.magnific-popup.min.js',array(),'1.1.0', true );	
		wp_enqueue_script( 'krystal-script', get_template_directory_uri() . '/js/compressed/krystal-main.min.js', array('jquery'), wp_get_theme()->get('Version'), true );		
		wp_enqueue_script( 'html5shiv',get_template_directory_uri().'/js/compressed/html5shiv.min.js',array(), '3.7.3');
		wp_script_add_data( 'html5shiv', 'conditional', 'lt IE 9' );

		wp_enqueue_script( 'respond', get_template_directory_uri().'/js/compressed/respond.min.js' );
...
function krystal_sticky_header_script() {
 	if(true===get_theme_mod( 'kr_sticky_menu',true)) {
 		if(true===get_theme_mod( 'kr_enable_minify_scripts',true)) {
 			wp_enqueue_script( 'krystal-sticky-script', get_template_directory_uri() . '/js/compressed/krystal-sticky.min.js', array('jquery'), wp_get_theme()->get('Version'), true );
 		}
 		else {
