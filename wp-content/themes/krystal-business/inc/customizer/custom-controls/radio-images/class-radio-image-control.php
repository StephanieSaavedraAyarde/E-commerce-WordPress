...
// Exit if Krystal_Business_Radio_Image_Control exists and WP_Customize_Control does not exsist.
if ( class_exists('Krystal_Business_Radio_Image_Control') && ! class_exists( 'WP_Customize_Control' ) ) {
	return null;
}
 ...
 * @access public
 */
class Krystal_Business_Radio_Image_Control extends WP_Customize_Control {
	...
	public function enqueue() {
        ...
        wp_enqueue_style( 'krystal-business-radio-image-control-css', trailingslashit(get_stylesheet_directory_uri()).'inc/customizer/custom-controls/radio-images/radio-image.css', array(), '1.0', 'all' );
	}
