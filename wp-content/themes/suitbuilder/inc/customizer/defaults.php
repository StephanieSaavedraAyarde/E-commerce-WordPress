...
if( !function_exists('suitbuilder_all_defalts_values') ) :
	...
	*/
	function suitbuilder_all_defalts_values(){
		...
		$suitbuilder_defaluts['suitbuilder-main-header-button-text']			= esc_html__('Get Started','suitbuilder');
		...
		$suitbuilder_defaluts['suitbuilder-enable-post-inner-header']			= 1;
		$suitbuilder_defaluts['suitbuilder-inner-banner-enable-meta']			= 0;
		$suitbuilder_defaluts['suitbuilder-inner-banner-enable-content']		= 1;
		...
		$suitbuilder_defaluts['suitbuilder-latest-blog-layout']					= 'blog-grid';
